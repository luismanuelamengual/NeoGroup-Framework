...
public abstract class DataSourceResourceProcessor<R extends Resource> extends ResourceProcessor<R> {
    ...
    private final Map<Class<? extends Resource>, ResourceTableMetadata> resourceMetadata;
    ...
    protected R create(R resource, Map<String, Object> params) {
        ...
        try {
            ResourceTableMetadata tableMetadata = getResourceTableMetadata((Class<? extends R>)resource.getClass());
            ...
            parameterIndex = 1;
            for (ResourceColumnMetadata columnMetadata : tableMetadata.getColumnMetadatas()) {
    ...
    protected List<R> retrieve(Class<? extends R> resourceClass, ResourceFilter filters, List<ResourceOrder> orders, Map<String, Object> params) {
        ...
        try {
            ResourceTableMetadata tableMetadata = getResourceTableMetadata(resourceClass);
            DataSource source = getDataSource();
            Connection connection = source.getConnection();
            ...
            if (filters != null) {
                sql.append(" WHERE ");
                buildFilterSQL(tableMetadata, filters, sql, sqlParameters);
            }
            ...
            if (orders != null) {
                ...
                while (orderIterator.hasNext()) {
                    ...
                    ResourceColumnMetadata columnMetadata = tableMetadata.getColumnMetadataByPropertyName(order.getProperty());
                    sql.append(columnMetadata.getColumnName());
                    sql.append(" ");
            ...
            while (resultSet.next()) {
                R resource = createResourceFromResultSet(tableMetadata, resultSet);
    ...
    private void buildFilterSQL(ResourceTableMetadata tableMetadata, ResourceFilter filter, StringBuilder sql, List<Object> sqlParameters) {
        ...
        if (filter instanceof ResourceFilterGroup) {
            ...
            while (resourceFilterIterator.hasNext()) {
                ...
                buildFilterSQL(tableMetadata, childResourceFilter, sql, sqlParameters);
            ...
            ResourceColumnMetadata columnMetadata = tableMetadata.getColumnMetadataByPropertyName(resourcePropertyFilter.getProperty());
    ...
    protected R createResourceFromResultSet (ResourceTableMetadata tableMetadata, ResultSet resultSet) {
        return null;
    }
